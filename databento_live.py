"""Per-user Databento live YM L2 connector for US30 Copilot 6.4.

Each US30 Copilot account may store its own encrypted Databento API key.
The server decrypts the key only in memory and starts a private YM.FUT MBP-10
...
class DatabentoOrderflowManager:
    ...
    def _handle_record(self, record: Any) -> None:
        ...
        self.publish({
            ...
            "bid_depth_10": round(bdepth, 2),
            "ask_depth_10": round(adepth, 2),
