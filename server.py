...
BUILD_ID = "2026-09-04-tv-onboarding-v10"
...
def health():
    ...
    return {
        ...
        "email":{"resend_configured":bool(RESEND_API_KEY),"reset_from_configured":bool(RESET_EMAIL_FROM),"reset_minutes":PASSWORD_RESET_MINUTES},
        "databento":{
